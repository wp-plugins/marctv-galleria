...
<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
                ...
                <td>
                    ...
                    <p>
                        <select name="marctv-galleria-size">
                            <?php foreach (array('thumbnail' => 'Thumbnail', 'medium' => 'Medium', 'large' => 'Large', 'full' => 'Full') as $k => $v) { ?>
            ...
            <tr valign="top">
                <th scope="row"> <?php echo __('Break Point', 'marctv-galleria'); ?></th>
                <td>
                    <p><label for="marctv-galleria-breakpoint">
                            <?php echo __('Choose the break point in pixels.', 'marctv-galleria'); ?>
                        </label></p>
                    <p>
            ...
            <tr valign="top">
                <th scope="row"> <?php echo __('Image Size Break-Point', 'marctv-galleria'); ?></th>
                <td>
